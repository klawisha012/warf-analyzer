  ...
  return (
    <div class="space-y-6">
      ...
      <section class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card title={t("mods.portfolioTitle") ?? "Mods Valuation"} class="relative overflow-hidden group">
          ...
          <div class="text-[11px] text-slate-500 font-mono mt-2 flex items-center gap-2">
            ...
            <span>Live value snapshot across visible upgrades and mods</span>
          </div>
        </Card>

        <Card title={t("mods.inventoryMetrics") ?? "Mod Inventory Metrics"} class="relative overflow-hidden group">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <div class="text-[10px] text-slate-500 font-mono uppercase tracking-wider mt-0.5">Unique Mods</div>
            </div>
            <div>
      ...
      <Card>
        ...
        >
          <Show
            ...
            fallback={<EmptyState title="No mods found" hint="Try adjusting your filter or minimum quantity" />}
          >
