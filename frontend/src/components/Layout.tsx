...
const IcoProfile = () => (
  <svg viewBox="0 0 24 24" fill="none">
    ...
    <path d="M4 21a8 8 0 0116 0" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" />
  </svg>
);
const IcoRiven = () => (
  <svg viewBox="0 0 24 24" fill="none">
    <path
      d="M12 2l2.4 5.6L20 9l-4.5 3.8L17 19l-5-3-5 3 1.5-6.2L4 9l5.6-1.4L12 2z"
      stroke="currentColor"
      stroke-width="1.5"
      stroke-linejoin="round"
    />
      ...
      <aside class="sidebar" aria-label="Главная навигация">
        <div class="brand">
          ...
          <div class="brand-name">
            Aleca<span class="dot">Frame</span>
          </div>
        </div>
            ...
            <div class="nav-children" ref={childrenRef} role="group" aria-label={t("nav.profile")}>
              <div class="nav-children-inner">
                <For each={PROFILE_CHILDREN}>
                  {(c) => (
                    <A href={c.href} class="nav-child" activeClass="active">
                      {t(c.key)}
                    </A>
                  )}
                </For>
