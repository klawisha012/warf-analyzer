...
def test_resolve_unique_name_sentinel_and_weapons_codenames(
    ...
    assert (
        resolver.resolve_unique_name("/Lotus/Types/Recipes/Weapons/SagekPrimeBlueprint")
    ...
    assert (
        resolver.resolve_unique_name("/Lotus/Types/Recipes/Weapons/BowPrimeBlueprint")
        == "paris_prime_blueprint"
    )

    # 11. VentoPrimeBlueprint -> venato_prime_blueprint
    assert (
        resolver.resolve_unique_name("/Lotus/Types/Recipes/Weapons/VentoPrimeBlueprint")
